...
This selection ensured the validity of within-subject comparisons in the paired statistical analysis
...
Functional capacity was evaluated as the main outcome, while quality of life was considered a secondary outcome.
...
The code used to generate Table 2 is available in Section 7 of the R notebook analysis_R.Rmd
...
### 3.2.1 Data visualization and descriptive analysis is available in Section 8 of the Python notebook exploratory_analysis.ipynb
...
### 3.2.2 Sattiscal analysis for the Wilcoxon test in Section 9 of the R notebook analysis_R.Rmd
...
The relationship between functional capacity and quality of life was assessed using Spearman’s rank correlation coefficient. The analysis showed no statistically significant correlation between 6-minute walk distance and PedsQL score (ρ = 0.19, p = 0.43).

The graphical representation supports this result. The scatter plot shows a wide dispersion of data points, with no clear monotonic pattern. Although a slight upward trend may be visually suggested, the loess smoothing curve remains relatively flat, indicating the absence of a consistent association.

Furthermore, the broad confidence interval around the smoothing curve reflects substantial inter-individual variability and a high level of uncertainty in the estimated relationship. This variability suggests that functional capacity alone does not adequately explain differences in perceived quality of life within this sample.

Overall, both the graphical and statistical analyses indicate the absence of a meaningful association between 6MWT performance and quality of life. These findings highlight the multifactorial nature of quality of life and suggest that factors beyond physical performance may play an important role in patient-reported outcomes.
...
A significant improvement in functional capacity was observed after the intervention, as demonstrated by the increase in 6-minute walk distance and confirmed by the Wilcoxon signed-rank test (p = 0.016). However, notable inter-individual variability in response was observed.

In contrast, no statistically significant correlation was found between functional capacity and quality of life (Spearman’s ρ = 0.19, p = 0.43), indicating that improvements in physical performance were not directly reflected in self-reported quality of life.
...
In addition, the interpretation of the results should be made with caution, as key variables such as age, sex, and body mass index vary substantially in pediatric populations. Greater methodological rigor would have required the use of standardized measures, such as BMI z-scores, which were not available in this dataset.
